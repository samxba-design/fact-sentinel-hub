  ...
  return (
    <div className="space-y-6 animate-fade-up max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Learn how to use Sentinel — your AI-powered brand monitoring and response platform
          </p>
        </div>
      </div>
      ...
      <Card className="bg-card border-border p-6 space-y-3">
        <h2 className="text-sm font-semibold text-foreground flex items-center gap-2">
          <Shield className="h-4 w-4 text-primary" /> What is Sentinel?
        </h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Sentinel is an AI-powered brand monitoring and crisis response platform. It continuously scans social media, news, forums, and blogs for mentions of your organization, analyzes sentiment and severity, detects misinformation and emerging narratives, and helps you draft <strong className="text-foreground">fact-checked, on-brand responses</strong> using only your Approved Facts library.
        </p>
